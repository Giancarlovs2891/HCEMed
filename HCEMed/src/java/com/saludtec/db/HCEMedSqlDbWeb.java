    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String anamnesis = "CREATE TABLE IF NOT EXISTS `Anamnesis` ("
                    ...
                    + "`hastaTratamientoEpilepsia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `medicacionEpilepsia` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosEpilepsia` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `fechaDiagnosticoTuberculosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tratamientoTuberculosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioTratamientoTuberculosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaTratamientoTuberculosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `medicacionTuberculosis` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosTuberculosis` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `fechaDiagnosticoOsteoporosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tratamientoOsteoporosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioTratamientoOsteoporosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaTratamientoOsteoporosis` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `medicacionOsteoporosis` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosOsteoporosis` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `fechaDiagnosticoHipertension` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tratamientoHipertension` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioTratamientoHipertension` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaTratamientoHipertension` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `medicacionHipertension` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosHipertension` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `fechaDiagnosticoProblemasPsiquiatricos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tratamientoProblemasPsiquiatricos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioTratamientoProblemasPsiquiatricos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaTratamientoProblemasPsiquiatricos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `medicacionProblemasPsiquiatricos` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosProblemasPsiquiatricos` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `fractura` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `fechaFractura` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cadera` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tobillo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `femur` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `muneca` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `antebrazo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `vertebra` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `columna` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otraFractura` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otraFracturaComentarios` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `causaFractura` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `recuperacionPostFractura` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `incapacidadTotal` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `unidadIncapacidadTotal` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosAntecedentesTraumatologicos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `menarquia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `menopausia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `histerectomia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `embarazos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `partos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `abortos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hijosVivos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `ciclos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `ur` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infertilidad` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `lactancia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `totalLactancia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `edadDeLosHijos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `tabaquismo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `fumadorPasivo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `fumaDesde` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaTabaquismo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `licor` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaLicor` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cerveza` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `vino` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `ron` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `whiskey` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `aguardiente` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosLicores` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cafe` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaCafe` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otroCafe` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioCafe` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `lecheDerivados` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaLecheDerivados` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otroLecheDerivado` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `inicioLecheDerivado` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frutasFrescas` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `queClasesFrutasFrescas` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `porcionesFrutasFrescas` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `realizaEjercicio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaEjercicio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `pescados` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `pescadoRio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `clasePescadoRio` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `vecesPescadoRio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `desdePescadoRio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaPescadoRio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaPescadoRio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `pescadoMar` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `blanco` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `clasePescadoMarBlanco` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `vecesPescadoMarBlanco` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `desdePescadoMarBlanco` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaPescadoMarBlanco` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaPescadoMarblanco` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `azules` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `clasePescadoMarAzules` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `vecesPescadoMarAzules` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `desdePescadoMarAzules` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `frecuenciaPescadoMarAzules` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hastaPescadoMarAzules` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `antecedentesQuirurgicos` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `otrosTratamientosAntecedentesQuirurgicos` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `comentariosAntecedentesQuirurgicos` longtext COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `diabetesNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `obesidadNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `colesterolNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `trigliceridosNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `infartosNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `hipertensionNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `cancerNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `osteoporosisNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosPadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosMadre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosHijo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosTioP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosTioM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosHnos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosAbueloP` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosAbueloM` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `otrosNinguno` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `fechaCreacionAn` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `horaCreacionAn` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL, `idUsuario` int(11) DEFAULT NULL, PRIMARY KEY (`idAnamnesis`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;";
