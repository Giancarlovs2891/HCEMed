...
function definirCamposExamenFisicoEvo(json) {
    ...
    if (obj.length > 0) {
        ...
        definirChecksEfEvo("piel", obj[0].piel);
        definirChecksEfEvo("ojos", obj[0].ojos);
        definirChecksEfEvo("oidosNarizGarganta", obj[0].oidosNarizGarganta);
        definirChecksEfEvo("cuello", obj[0].cuello);
        definirChecksEfEvo("torax", obj[0].torax);
        definirChecksEfEvo("cardiovascular", obj[0].cardiovascular);
        definirChecksEfEvo("respiratorios", obj[0].respiratorios);
        definirChecksEfEvo("abdomen", obj[0].abdomen);
        definirChecksEfEvo("genitourinario", obj[0].genitourinario);
        definirChecksEfEvo("extremidades", obj[0].extremidades);
        definirChecksEfEvo("sistemaNerviosoCentral", obj[0].sistemaNerviosoCentral);
        definirChecksEfEvo("adenopatias", obj[0].adenopatias);
        definirChecksEfEvo("otros", obj[0].otros);
...
function definirChecksEfEvo(nombreCheck, valorCheck) {
