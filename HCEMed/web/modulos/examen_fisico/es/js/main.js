...
function guardarEvolucionEf() {
    var stringEvolucion = "nombreModulo=ExamenFisico&evolucion=evolucion de examen fisico&fecha=" + fechaActual() + "&hora=" + horaActual() + "&idPaciente=" + getPatientId();
    guardarTabla("Evolucion", stringEvolucion, nada);
    function nada() {
    }
}
